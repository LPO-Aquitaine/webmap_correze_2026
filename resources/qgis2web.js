...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [83650.870255, 5607461.207857, 389703.113901, 5750149.809539], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([83650.870255, 5607461.207857, 389703.113901, 5750149.809539], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Enquête Hirondelles 2026 - Choix des mailles à prospecter en Corrèze</h2>';
        return titleElement;
    })(),
